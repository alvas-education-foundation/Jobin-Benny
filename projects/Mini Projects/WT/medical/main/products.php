...
<a  href="index.php"><button class="btn btn-default btn-large" style="float: left;"><i class="icon icon-circle-arrow-left icon-large"></i> Back</button></a>
			<?php 
			include('../connect.php');
				$sql = "SELECT * FROM products ORDER BY qty_sold DESC";
				$result=$db->query($sql);
			...
			<?php 
			include('../connect.php');
				$sql = "SELECT * FROM products where qty < 10 ORDER BY product_id DESC";
				$result=$db->query($sql);
...
<table class="hoverTable" id="resultTable" data-responsive="table" style="text-align: left;">
	...
	<tbody>
			...
			function formatMoney($number, $fractional=false) {
				...
				include('../connect.php');
				$sql ="SELECT *, price * qty as total FROM products ORDER BY product_id DESC";
				$result=$db->query($sql);
