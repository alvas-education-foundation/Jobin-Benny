...
<head>
<center>
    <marquee><strong>Medical Store Managment system</strong></marquee>
<title>
POS
</title>
...
<form action="login.php" method="post">
			...
			<font style=" font:bold 44px 'Aleo'; text-shadow:1px 1px 15px #000; color:#fff;"><center>MEDICAL STORE</center></font>
		<br>
